...
dataset_test=Instruction_datast(csv_file='Vyoutube_test.csv',tokenizer=tokenizer,Max_length=None)
dataset_val=Instruction_datast(csv_file='Vyoutube_validation.csv',tokenizer=tokenizer,Max_length=None)
dataset_train=Instruction_datast(csv_file='Vyoutube_train.csv',tokenizer=tokenizer,Max_length=None)
            ...
            if global_step % eval_freq == 0:
                ...
                if val_acc > best_val_accuracy:
                    if (train_acc - val_acc) <0.05:
                        ...
                        }, f'youtube_model{int(train_acc*100)}_{int(val_acc*100)}_.pt')
